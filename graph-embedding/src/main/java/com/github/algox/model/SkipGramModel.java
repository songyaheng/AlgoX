...
public class SkipGramModel extends AbstractTrainer {

    SkipGramModel(NNConfig config, Multiset<String> vocab, Map<String, HuffmanNode> huffmanNodes) {
        ...
        public void trainSentence(List<String> sentence) {
            ...
            for (int sentencePosition = 0; sentencePosition < sentenceLength; sentencePosition++) {
                ...
                for (int a = b; a < window * 2 + 1 - b; a++) {
                    ...
                    int l1 = huffmanNodes.get(sentence.get(c)).index;
    ...
    @Override
    protected AbstractTrainer.Worker createWorker(int randomSeed, int iter, Iterable<List<String>> batch) {
